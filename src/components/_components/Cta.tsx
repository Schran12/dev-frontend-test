  ...
  return (
    <section className="max-w-6xl mx-auto px-6 sm:px-12 md:px-24 lg:px-32 text-center py-12 bg-[#a81a1a] rounded-xl text-white mt-20">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
        Quer transformar sua indústria?
      </h2>
      <p className="text-base sm:text-lg md:text-xl mb-6">
        Entre em contato com a InduxMax e descubra como nossas soluções em automação e energia sustentável podem aumentar eficiência e reduzir custos.
      </p>
      <Link
        href="/contato"
